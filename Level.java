...
To construct levels using the Builder pattern where the Builder object is not only responsible for creating the final Level object,
but will also ensure that the objects that are added to the level are from a predefined set.
 */
package dungeon;
