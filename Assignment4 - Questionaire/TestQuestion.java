...
public class TestQuestion {
    ...
    public void trueFalseTest() {
        Question questionaire;
        questionaire = new TrueFalse("Is black blue?", "False");
        assertEquals("Is black blue?", questionaire.getText());
    ...
    public void questionsOrderingTest() {
        ...
        Question[] questionnaire = {q1, q3, q4, q6};
        Question[] correctOrder = {q3, q4, q1, q6};
